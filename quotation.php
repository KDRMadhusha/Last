      ...
      <div class="site__body">
        <div class="page-header">
          <div class="page-header__container container">
            ...
            <div class="page-header__title"><h1>Quotation</h1></div>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-12 mb-3">
                <div class="alert alert-lg alert-primary">
                  Returning customer? <a href="account.php">Click here to login</a>
                </div>
              </div>
              <div class="col-12 col-lg-6 col-xl-7">
                <div class="card mb-lg-0">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="checkout-city">Quantity</label>
                      <input
                        type="text"
                        class="form-control"
                        id="checkout-city"
                    ...
                    <div class="form-group">
                      <label for="checkout-state">Shipping Cost ($)</label>
                      <input
                        type="text"
                        class="form-control"
                        id="checkout-state"

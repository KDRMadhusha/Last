            ...
            <div class="page-header__breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">
                    <a href="#">Gems Diamond & Jewellery</a>
          ...
          <div class="shop-layout shop-layout--sidebar--start">
            <div class="shop-layout__sidebar">
              ...
              <div class="block-sidebar__item">
                  ...
                  >
                    <h4 class="widget__title">Gems Diamond & Jewellery</h4>
                    ...
                    <div class="widget-products__list">
                      <div class="widget-products__item">
                        <div class="widget-products__image">
                          <a href="product.php"
                            ><img src="images/products/product-ge1.jpg" alt=""
                          /></a>
                        </div>
                        <div class="widget-products__info">
                          <div class="widget-products__name">
                            <a href="product.php"
                              >Traditional Gold Chain</a
                            >
                          </div>
                      ...
                      <div class="widget-products__item">
                        <div class="widget-products__image">
                          <a href="product.php"
                            ><img src="images/products/product-ge2.jpg" alt=""
                          /></a>
                        </div>
                        <div class="widget-products__info">
                          <div class="widget-products__name">
                            <a href="product.php"
                              >Diamond Jewellery Set</a
                            >
                          </div>
                      ...
                      <div class="widget-products__item">
                        <div class="widget-products__image">
                          <a href="product.php"
                            ><img src="images/products/product-ge3.jpg" alt=""
                          /></a>
                        </div>
                        <div class="widget-products__info">
                          <div class="widget-products__name">
                      ...
                      <div class="widget-products__item">
                        <div class="widget-products__image">
                          <a href="product.php"
                            ><img src="images/products/product-ge4.jpg" alt=""
                          /></a>
                        </div>
                        <div class="widget-products__info">
                          <div class="widget-products__name">
                            <a href="product.php"
                              >Squre Ruby Gemstone</a
                            >
                          </div>
                      ...
                      <div class="widget-products__item">
                        <div class="widget-products__image">
                          <a href="product.php"
                            ><img src="images/products/product-ge5.jpg" alt=""
                          /></a>
                        </div>
                        <div class="widget-products__info">
                          <div class="widget-products__name">
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <p>The buyer is interested to receive quotations for the following RFQ - Product Name: Fashionable Jewellery Specifications: Type: Trendy Necklace, Beaded Bracelets, Chain Necklace, Adjustable Necklace, Stone Necklace, Pendants, Hoop Earrings, Etc. For Ladies Designed Only Quantity Required : 300 - 400 Piece/Pieces(sample) Shipping Terms : FOB Destination Port : Israel Payment Terms : To be discussed with suppliers Looking for suppliers from : Worldwide Contact : Neta</p>
                          </div>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <p>Please provide a quotation to the following requirement from the importer - Product Name: Imitation Jewellery Specifications: Type: Bangles, Necklaces, Earrings, Nose Pins, Rings, Bracelets, Etc. Included: Gemstones, Ruby, Turquoise, Emerald, Etc. Material: Glass, Metal, Pearl, Beads, etc. Size: As Per requirement Packaging Terms : Standard Quantity Required : MOQ Shipping Terms : CNF Destination Port : Thailand Payment Terms : L/C Or T/T Looking for suppliers from : Worldwide Contact : Paul</p>
                          </div>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <h6>Payment Method: FOB</h6>
                            <h6>Qty: 5 carton/1 month</h6>
                            <p>Please provide a quotation to the following requirement from the importer - Product Name: Jewellery Items Specifications: Silver, To Glass, Stone, Ceramic, Acrylic, Etc. Earrings, Necklace, Anklet, Ring, Etc. Quantity Required : 1 Twenty-Foot Container(sample) Shipping Terms : CIF Destination Port : Paris, France Payment Terms : To be discussed with suppliers Looking for suppliers from : Worldwide Contact : Elina</p>
                          </div>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <h6>Payment Method: FOB</h6>
                            <h6>Qty: 1 carton/1 month</h6>
                            <p>The buyer is interested to receive quotations for the following RFQ - Product Name: Gemstones Specifications: Type: Pearls, Topaz, Moonstones Standard And Genuine Quality Use: For Making Accessories Size: Standard (Customized) Quantity Required : 1 Twenty-Foot Container(sample) Shipping Terms : FOB Destination Port : Japan Payment Terms : T/T Looking for suppliers from : Worldwide Contact : Hara</p>
                          </div>

  ...
  <body>
    ...
    <div class="site">
              ...
              <div class="nav-panel__container container">
                <div class="nav-panel__row">
                  <div class="nav-panel__departments">
                    <!-- .departments -->
                    <div
                      class="departments departments--opened departments--fixed"
                            ...
                            >
                              ...
                              <div class="departments__menu">
                                ...
                                <ul class="menu menu--layout--classic">
                                  ...
                                  <li><a href="#">Ayurwedic & Herbal Products</a></li>
      ...
      <div class="site__body">
            ...
            <div class="block-features__list">
              <div class="block-features__item">
                ...
                <div class="block-features__content">
                  <div class="block-features__title">Shipping</div>
        ...
        <div class="block block-products-carousel" data-layout="grid-4">
          <div class="container">
            <div class="block-header">
              <h3 class="block-header__title">Lastest Products</h3>
                ...
                <div class="block-products-carousel__column">
                  <div class="block-products-carousel__cell">
                    <div class="product-card">
                      ...
                      <div class="product-card__info">
                        <div class="product-card__name">
                          <a href="product.php">Ladies Hats</a>
                        </div>
                        <div class="product-card__rating">
                          <div class="rating">
                            <div class="rating__body">
          ...
          <div class="container">
            <a href="#" class="block-banner__body"
              ...
              <div
                ...
                style="
                  background-image: url('images/banners/banner-1-mobile.jpg');
                "
              ></div>
        ...
        <!-- .block-products / end --><!-- .block-posts -->
        <div
        ...
        >
          <div class="container">
            <div class="block-header">
              <h3 class="block-header__title">Feedback</h3>
              <div class="block-header__divider"></div>
              <div class="block-header__arrows-list">
                <button
                  class="block-header__arrow block-header__arrow--left"
              ...
              <div class="owl-carousel">
                ...
                <div class="post-card">
                  ...
                  <div class="post-card__info">
                    ...
                    <div class="post-card__name">
                      <a href="#"
                        >Engineers Use Many Methods To Minimize Logic
                        Functions</a
                      >
                    </div>
        ...
        <!-- .block-posts / end --><!-- .block-product-columns -->

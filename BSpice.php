          ...
          <div class="shop-layout shop-layout--sidebar--start">
            <div class="shop-layout__sidebar">
              ...
              <div class="block-sidebar__item">
                  ...
                  >
                    <h4 class="widget__title">Spices & Essential Oils</h4>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <p>Please provide a quotation to the following requirement from importer - Product Name: Black Pepper Specifications : Black Pepper 500 G/l Or 55+ G/l Quantity Required : 1 Twenty-Foot Container Shipping Terms : CIF Destination Port : Rijeka, Croatia Payment Terms : L/C Looking for suppliers from : Worldwide Contact : Tamara Vrhovac</p>
                          </div>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <p>The buyer would like to receive quotations for - Product Name: Cardamom Specifications : Size: 7-8mm 8mm Quantity Required : 100 Kilogram/Kilograms Shipping Terms : By Road Destination Port : India Payment Terms : Bank Transfer Looking for suppliers from : India Contact : Sudipto Majumdar</p>
                          </div>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <h6>Country: Saudi Arabia</h6>
                           
                            <h6>Payment Method: FOB</h6>
                            <h6>Qty: 50 carton/1 month</h6>
                            <p>Please provide a quotation to the following requirement from importer - Product Name : Cinnamon Specifications : Type: Cinnamon in Branch / Pure Cinnamon Processing Type: Raw / Powder Style: Dried Cultivation Type: Common Quantity Required : 1 Twenty-Foot Container Shipping Terms : CIF Destination Port : Algeciras, Spain Payment Terms : To be discussed with suppliers Looking for suppliers from : Worldwide Contact : Elvira</p>
                          </div>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <h6>Country: Essen, Germany</h6>
                           
                            <h6>Payment Method: FOB</h6>
                            <h6>Qty: 10 carton/1 month</h6>
                            <p>The buyer would like to receive quotations for - Product Name: Essential Oils Specifications: Type: Anise Seed Oil, Cypress Oil, Clementine Oil, Clove Oil, Etc. Quantity Required : 1 Metric Ton/Metric Tons Shipping Terms : FOB Or CIF Destination Port : Spain Payment Terms : CAD Looking for suppliers from : Worldwide Contact : Ruiz</p>
                          </div>

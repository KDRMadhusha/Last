      ...
      <div class="site__body">
        <div class="page-header">
          <div class="page-header__container container">
            ...
            <div class="page-header__title"><h1>Seller Post</h1></div>
          </div>
        </div>
        <div class="block">
          <div class="container">
              ...
              <div class="col-md-6 d-flex">
                <div class="card flex-grow-1 mb-md-0">
                  <div class="card-body">
                    ...
                    <form method="POST" action="Lauthentication.php">
                      ...
                      <div class="form-group">
                        <table>
                        <tr ><td>                              
                          <label id="label"> Minimum Quantity</label>
                        </td>
                        ...
                        <div class="form-group">
                          ...
                          /></td>
                          <td>  
                          <label> $ </label></td><td></td><td></td><td></td>
                        </tr>
                        </table>
                      </div>
                    </div>

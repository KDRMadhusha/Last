          ...
          <div class="shop-layout shop-layout--sidebar--start">
            <div class="shop-layout__sidebar">
              ...
              <div class="block-sidebar__item">
                  ...
                  >
                    <h4 class="widget__title">Food Feed & Beverages</h4>
                  ...
                  <div class="widget-products widget">
                    ...
                    <div class="widget-products__list">
                      ...
                      <div class="widget-products__item">
                        <div class="widget-products__image">
                          <a href="product.php"
                            ><img src="images/products/product-fo3.jpg" alt=""
                          /></a>
                        </div>
                        <div class="widget-products__info">
                          <div class="widget-products__name">
                      ...
                      <div class="widget-products__item">
                        <div class="widget-products__image">
                          <a href="product.php"
                            ><img src="images/products/product-fo4.jpg" alt=""
                          /></a>
                        </div>
                        <div class="widget-products__info">
                          <div class="widget-products__name">
                      ...
                      <div class="widget-products__item">
                        <div class="widget-products__image">
                          <a href="product.php"
                            ><img src="images/products/product-fo5.jpg" alt=""
                          /></a>
                        </div>
                        <div class="widget-products__info">
                          <div class="widget-products__name">
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <h6>Country: Norsborg, Sweden</h6>
                           
                            <h6>Payment Method: FOB</h6>
                            <h6>Qty: 10 carton/1 month</h6>
                            <p>The buyer would like to receive quotations for - Product Name: Animal Feed Specifications : Type: Barley In 4 Shipments, Each Shipment 25 Thousand Tons Who Has Ready Stock And We Agree On Price, Payment And Commission, We Can Start With Him Quantity Required : 100000 Ton/Tons Shipping Terms : CIF Destination Port : United Arab Emirates Payment Terms : To be discussed with suppliers Looking for suppliers from : Worldwide Contact : Ahmed Hussain Ubaidullah</p>
                          </div>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <p>Buyer is interested to receive quotations for the following RFQ - Product Name: Black Tea, Green Tea Quantity Required : 1 Twenty-Foot Container Shipping Terms : FOB And CIF Destination Port : United Arab Emirates Payment Terms : L/C Looking for suppliers from : Worldwide Contact : Mohamad</p>
                          </div>
                      ...
                      <div class="products-list__item">
                        <div class="product-card">
                          ...
                          <div class="product-card__info">
                            ...
                            <p>Please quote for the following wholesale product requirement - Product Name: Hell Energy Drinks Quantity Required : MOQ Shipping Terms : CIF Destination Port : India Payment Terms : To be discussed with suppliers Looking for suppliers from : Turkey, Austria, India Contact : Md Zaib</p>
                          </div>
